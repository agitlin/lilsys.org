const id = "successful-wfh-day.md";
						const collection = "articles";
						const slug = "successful-wfh-day";
						...
						const data = {title:"The Successful Work-From-Home Day Formula",date:"2026-01-14",tags:["productivity","systems","balance","workflow"],description:"A successful day is when you thread enough self-care through everything else to stay centered — not waiting until all the work is done."};
						const _internal = {
							type: 'content',
							filePath: "/sessions/kind-gracious-gauss/mnt/1u/sites/lilsys.org/src/content/articles/successful-wfh-day.md",
							rawData: undefined,
						};
